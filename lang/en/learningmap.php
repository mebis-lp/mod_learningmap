...
$string['hidepaths_help'] = 'This option hides the paths for the students while they remain functional for building dependencies between the activities.';
...
$string['showall_help'] = 'This option shows all paths and places of the map. Places and paths not yet reachable are dimmed.';
...
$string['showtext_help'] = 'This option shows the names of the activities as a text besides the places. The text can be moved and is automatically updated when the name changes.';
$string['slicemode'] = 'Reveal map with places';
$string['slicemode_help'] = 'This option subsequently reveals the map when new places become reachable. The hidden parts of the map are covered with fog. When all places become reachable, the whole map is visible.';
